...
def menu_apikey():
  ...
  id = "∞".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/jahid-gst/Jahid-69/main/Apruval.txt').text
  
 

  os.system(" clear")                          
  print("""\033[1;37m
\033[92;1m   _         _    _ _____ _____   
\033[92;1m  | |  /\   | |  | |_   _|  __ \          
\033[97;1m   | | /  \  | |__| | | | | |  | |      
\033[97;1m    _   | |/ /\ \ |  __  | | | | |  | |              
\033[92;1m    | |__| / ____ \| |  | |_| |_| |__| |     
\033[92;1m     \____/_/    \_\_|  |_|_____|_____/     
...
\033[1;33m╚════════════════════════════════════════════════╝""")                                         
  ...
  os.system('xdg-open https://www.facebook.com/jahid.ahmad54768')
  print("");time.sleep(2)
  print("\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("q").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+8801957550919?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mJahid Ahmed [Balnk] ( 𝐌 )  \033[38;5;46m           ▇▎  
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+880101957550919');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/jahid.ahmad54768');time.sleep(1)
		admin()
	if bal =='3':
